    ...
    CKEDITOR.dialog.add("link", function (g) {
        ...
        return {
            ...
            contents: [{
                ...
                elements: [{
                    ...
                    items: [
                        ...
                        [b.toAnchor, "anchor"],
                        [b.toEmail, "email"],
                       //Task:4712 :Added sharepointlist option in the link dropdown
                         [b.toSharePointList, "sharepointlist"]
                    ],
                    onChange: function () {
                         var a = this.getDialog(),
                            //Task:4712
                            b = ["urlOptions", "anchorOptions", "emailOptions", "sharepointlistOptions"],
                            k = this.getValue(),
                       ...
                       "url" == k ? (g.config.linkShowTargetTab && a.showPage("target"), e || a.showPage("upload")) : (a.hidePage("target"), e || a.hidePage("upload"));
                        //Task:4712 :Show target tab and hide advanced tab in sharpointlist
                       if ("sharepointlist" == k) {
                           a.showPage("target");
                           a.hidePage("advanced");
                       }
                       else { a.showPage("advanced"); }
                    ...
                    children: [{
                     ...
                     //Task 5225 - Removed Browse server button from link dialog
                    ]
                },
               ...
               //Task:4712 :Added controls in sharepointlist
               {
                   type: "vbox",
                   id: "sharepointlistOptions",
                   padding: 1,
                   children: [
                       ...
                       //"Name" textbox
                      {
                        ...
                        label: b.name,
                        "default": "",
                         //validations  for name and url textboxes
                        validate: function () {
                            var a = this.getDialog();
                            var c = this.getDialog().getContentElement("info", "listurl");
                            if ("sharepointlist" == a.getValueOf("info", "linkType")) {
                                if (!this.getValue() && !c.getValue()) {
                                    alert(b.noTextandUrl);
                                   return false;
                                }
                                ...
                                //Task: 5123 Removed validation for wrong url in video source textbox
                                return true;
                            }
                        },
                       
                        setup: function (a) {
                            //Task 4970 - show selected text in the sharpoint name textbox
                            g.getSelection().getSelectedText() ? this.setValue(g.getSelection().getSelectedText()) : (a.sharepointlist && this.setValue(a.sharepointlist.name));
                            (a = this.getDialog().getContentElement("info", "linkType")) && "sharepointlist" == a.getValue() && this.select();
                            this.allowOnChange = !0;
                        },
                        commit: function (a) {
                            a.sharepointlist || (a.sharepointlist = {});
                            a.sharepointlist.name = this.getValue();
                            this.allowOnChange = !1;
                      ...
                      //"URL" textbox
                    {
                       ...
                       setup: function (a) {
                           a.sharepointlist && this.setValue(a.sharepointlist.listurl);
                           (a = this.getDialog().getContentElement("info", "linkType")) && "sharepointlist" == a.getValue() && this.select();
                           this.allowOnChange = !0
                       },
                        commit: function (a) {
                            a.sharepointlist || (a.sharepointlist = {});
                            a.sharepointlist.listurl = this.getValue();
                            this.allowOnChange = !1;
                          }
                     } 
            ...
            onShow: function () {
                ...
                //Task 4831 - To show the selected values in the name textbox of sharepointlist
                if (a.type == 'sharepointlist') {
                    a.sharepointlist.name = c.$.innerText;
                }
            ...
            onOk: function () {
                ...
                if (this._.selectedElement) {
                    var e = this._.selectedElement,
                        ...
                        f = e.getHtml();
                    //Task 4831 - update the text in ckeditor if name of the link changed   
                    if (a.type == "sharepointlist") {
                         e.$.innerText = a.sharepointlist.name;
                    }
                    ...
                    if(b.collapsed)
                    {
                        if(a.type == "email")
                        {
                            a = new CKEDITOR.dom.text(a.email.address, g.document);
                        }
                        if(a.type == "url")
                        {
                            a = new CKEDITOR.dom.text(c.set["data-cke-saved-href"], g.document);
                        }
                        //Task:4712 : takes the value from "Name" textbox and inserts node CKEDITOR.dom.text object
                        if(a.type == "sharepointlist")
                        {
                            //Task 4831: takes the value fron sharepoint list "name" textbox and inserts node CKEDITOR.dom.text object
                            a = new CKEDITOR.dom.text(a.sharepointlist.name, g.document);
                        }
                        b.insertNode(a)
                        //Task 4970 - Moved below line inside the else condition as it was giving error while selecting the text and trying to save as a link url
